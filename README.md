...
1.	Put the music mp3's in a folder on your Windows desktop computer and give the folder a name.
2.	Right-click the folder with the MP3's and select Send To (Compressed) Zipped Folder
3.	Upload that zipped folder to your Dropbox account

THEN ON IPAD
1. In the Files app, navigate to your Dropbox location and find the zip file
2. Long press the zip file → tap Copy
3. Navigate to On My iPad → find your GoLoco folder (you must have already created this folder) → go inside it
4. Long press on an empty space inside the GoLoco folder → tap Paste
5. Tap the zip file once — iOS unzips it automatically (I know!)

In GoLoco tap the Add Music Files button and go to the GoLoco folder to select songs you wish to load. If you wish you can load more than one folder's worth of files. 
